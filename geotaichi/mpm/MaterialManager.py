...
from ..mpm.Contact import ContactBase
from ..mpm.Simulation import Simulation
from ..physics_model.consititutive_model.ConstitutiveModelBase import ConstitutiveBase
from ..utils.linalg import read_dict_list
...
class MaterialHandle(ConstitutiveBase):
    ...
    def material_handle(self, sims: Simulation, constitutive_model):
        from ..physics_model.consititutive_model.infinitesimal_strain.LinearElastic import LinearElasticModel
        from ..physics_model.consititutive_model.infinitesimal_strain.ElasticPerfectlyPlastic import ElasticPerfectlyPlasticModel
        from ..physics_model.consititutive_model.infinitesimal_strain.MohrCoulomb import MohrCoulombModel
        from ..physics_model.consititutive_model.infinitesimal_strain.StateDependentMohrCoulomb import StateDependentMohrCoulombModel
        from ..physics_model.consititutive_model.infinitesimal_strain.DruckerPrager import DruckerPragerModel
        from ..physics_model.consititutive_model.infinitesimal_strain.ModifiedCamClay import ModifiedCamClayModel
        from ..physics_model.consititutive_model.strain_rate.Newtonian import NewtonianModel
        from ..physics_model.consititutive_model.strain_rate.Bingham import BinghamModel
        from ..physics_model.consititutive_model.UserDefined import UserDefined
        if constitutive_model == "None" or constitutive_model == "RigidBody":
            from ..physics_model.consititutive_model.RigidBody import RigidModel
        ...
        if sims.material_type == "Solid" or sims.material_type == "TwoPhaseSingleLayer" or sims.material_type == "TwoPhaseDoubleLayer":
            ...
            if constitutive_model == "HenckyElastic":
                ...
                from ..physics_model.consititutive_model.finite_strain.HenckyElastic import HenckyElasticModel
                ...
                from ..physics_model.consititutive_model.finite_strain.NeoHookean import NeoHookeanModel
                ...
                if sims.stabilize == "B-Bar Method":
                    raise RuntimeError("B bar method is unsupported in NeoHookean material")
                from ..physics_model.consititutive_model.finite_strain.MooneyRivlin import MooneyRivlin
                ...
                if sims.stabilize == "B-Bar Method":
                    raise RuntimeError("B bar method is unsupported in NeoHookean material")
                from ..physics_model.consititutive_model.finite_strain.Gent import Gent
                ...
                if sims.stabilize == "B-Bar Method":
                    raise RuntimeError("B bar method is unsupported in NeoHookean material")
                from ..physics_model.consititutive_model.finite_strain.Hydrogel import Hydrogel
