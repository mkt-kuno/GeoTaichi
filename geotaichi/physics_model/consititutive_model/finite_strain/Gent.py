...
from ..utils.MatrixFunction import matrix_form
...
class Gent(FiniteStrainModel):
    ...
    def corePK(self, np, stateVars):  
        ...
        Jm1, Jm2 = self.Jm1, self.Jm2
        F = stateVars[np].deformation_gradient
        det_F = F.determinant()
        dUdI1 = 0.5 * shear_modulus * Jm1 / (Jm1 - getI1(F) + 3.) 
        dUdI2 = 0.5 * shear_modulus * Jm2 / (Jm2 - getI1(F) + 3.) 
